function solve() {
    ...
    if (yuzlar != 0) {
        ...
        if (A > 99 && A <= 999) {
            ...
            else if (yuzlar > unlar && unlar > birlar && yuzlar > birlar) {
                document.getElementById("demo").innerHTML = "Barcha raqamlar ketma-ket kamayuvchi"
            }

            else {
                document.getElementById("demo").innerHTML = "raqamlar ketma-ket o'suvchi ham kamayuvchi ham emas"
            }
        }
